...
class Constraint4 extends React.Component<Props, State> {
  ...
  public handleChangeConstraint4IsEnabled = (
    _: React.ChangeEvent<HTMLInputElement>,
    checked: boolean
  ) => {
    this.props.dispatch(
      constraints4.updateConstraint4IsEnabled(
        this.props.constraint4.id,
        checked
      )
    );
  };
  public handleChangeConstraint4MemberId = (
  ...
  public handleChangeConstraint4KinmuId = (
    event: React.ChangeEvent<HTMLInputElement>
  ) => {
    this.props.dispatch(
  ...
  public handleChangeConstraint4MaxNumberOfAssignments = (
    event: React.ChangeEvent<HTMLInputElement>
  ) => {
    this.props.dispatch(
  ...
  public handleClickDeleteConstraint4 = () => {
    this.setState({ deletionDialogIsOpen: false });
    this.props.dispatch(
      constraints4.deleteConstraint4(this.props.constraint4.id)
    );
  };
  public render() {
      ...
      <>
        <span
          className={classnames({
            [this.props.classes.lineThrough]: !constraint4Member.is_enabled,
          })}
        >
        ...
        <span
          className={classnames({
            [this.props.classes.lineThrough]: !constraint4Kinmu.is_enabled,
          })}
        >
          {constraint4Kinmu.name}
        </span>
        を{this.props.constraint4.max_number_of_assignments}回以下割り当てる
      </>
    );
    const errorMessages = this.validate(
      this.props.constraint4.max_number_of_assignments
    );
    return (
      <>
        <Card>
          <CardHeader
            avatar={
              <Switch
                checked={
                  this.props.constraint4.is_enabled && relativesAreEnabled
                }
              ...
              <Grid container={true} spacing={8}>
                ...
                <Grid item={true} xs={12}>
                  <TextField
                    ...
                    onChange={
                      this.handleChangeConstraint4MaxNumberOfAssignments
                    }
                    fullWidth={true}
                    inputProps={{
        ...
        >
          ...
          <DialogActions>
            <Button color="primary" onClick={this.handleClickDeleteConstraint4}>
              削除
            </Button>
