...
class Constraints6 extends React.Component<Props, State> {
  ...
  public validate(newConstraint6MaxNumberOfDays: number): ErrorMessages {
    ...
    if (isNaN(newConstraint6MaxNumberOfDays)) { errorMessages.newConstraint6MaxNumberOfDays.push('連続日数上限の形式が正しくありません') }
        ...
        <div className={this.props.classes.gridFrame}>
          <Grid container={true} spacing={8}>
            <Grid item={true} xs={12}>
              <Toolbar>
                <Typography variant="subheading" className={this.props.classes.toolbarTitle}>勤務の連続日数の上限</Typography>
                  ...
                  <Grid container={true} spacing={8}>
                    <Grid item={true} xs={12}>
                      <FormControlLabel
                        control={
                          <Switch
                            checked={this.state.newConstraint6IsEnabled && relativesAreEnabled}
