...
const UPDATE_CONSTRAINT10_START_DATE_NAME =
  "UPDATE_CONSTRAINT10_START_DATE_NAME";
...
export function updateConstraint10IsEnabled(
  id: number,
  is_enabled: boolean
): UpdateConstraint10IsEnabled {
  return {
...
export function updateConstraint10MemberId(
  id: number,
  member_id: number
): UpdateConstraint10MemberId {
  return {
...
export function updateConstraint10StartDateName(
  id: number,
  start_date_name: string
): UpdateConstraint10StartDateName {
  return {
...
export function updateConstraint10StopDateName(
  id: number,
  stop_date_name: string
): UpdateConstraint10StopDateName {
  return {
...
export function updateConstraint10KinmuId(
  id: number,
  kinmu_id: number
): UpdateConstraint10KinmuId {
  return {
