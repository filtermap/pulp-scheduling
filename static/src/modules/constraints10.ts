...
export const getErrorMessages = (
  ...
  const startDate =
    sample.constraint10.start_date_name &&
    utils.stringToDate(sample.constraint10.start_date_name);
  const stopDate =
    sample.constraint10.stop_date_name &&
    utils.stringToDate(sample.constraint10.stop_date_name);
  if (!startDate)
