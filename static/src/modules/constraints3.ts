...
const UPDATE_CONSTRAINT3_MIN_NUMBER_OF_ASSIGNMENTS =
  "UPDATE_CONSTRAINT3_MIN_NUMBER_OF_ASSIGNMENTS";
...
export function createConstraint3(
  is_enabled: boolean,
  member_id: number,
  kinmu_id: number,
  min_number_of_assignments: number
...
export function updateConstraint3IsEnabled(
  id: number,
  is_enabled: boolean
): UpdateConstraint3IsEnabled {
  return {
...
export function updateConstraint3MemberId(
  id: number,
  member_id: number
): UpdateConstraint3MemberId {
  return {
...
export function updateConstraint3KinmuId(
  id: number,
  kinmu_id: number
): UpdateConstraint3KinmuId {
  return {
...
export function updateConstraint3MinNumberOfAssignments(
  id: number,
  min_number_of_assignments: number
): UpdateConstraint3MinNumberOfAssignments {
  return {
