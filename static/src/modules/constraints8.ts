...
const UPDATE_CONSTRAINT8_MAX_NUMBER_OF_DAYS = 'UPDATE_CONSTRAINT8_MAX_NUMBER_OF_DAYS'
...
export function createConstraint8(is_enabled: boolean, kinmu_id: number, max_number_of_days: number): CreateConstraint8 {
  return {
    is_enabled,
    kinmu_id,
    max_number_of_days,
...
export function updateConstraint8IsEnabled(id: number, is_enabled: boolean): UpdateConstraint8IsEnabled {
  return {
    id,
    is_enabled,
...
export function updateConstraint8KinmuId(id: number, kinmu_id: number): UpdateConstraint8KinmuId {
  return {
    id,
    kinmu_id,
...
export function updateConstraint8MaxNumberOfDays(id: number, max_number_of_days: number): UpdateConstraint8MaxNumberOfDays {
  return {
    id,
    max_number_of_days,
