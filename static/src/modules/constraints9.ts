...
export function createConstraint9(is_enabled: boolean, member_id: number, start_date_name: string, stop_date_name: string, kinmu_id: number): CreateConstraint9 {
  return {
    is_enabled,
    kinmu_id,
    member_id,
...
export function updateConstraint9IsEnabled(id: number, is_enabled: boolean): UpdateConstraint9IsEnabled {
  return {
    id,
    is_enabled,
...
export function updateConstraint9MemberId(id: number, member_id: number): UpdateConstraint9MemberId {
  return {
    id,
    member_id,
...
export function updateConstraint9StartDateName(id: number, start_date_name: string): UpdateConstraint9StartDateName {
  return {
    id,
    start_date_name,
...
export function updateConstraint9StopDateName(id: number, stop_date_name: string): UpdateConstraint9StopDateName {
  return {
    id,
    stop_date_name,
...
export function updateConstraint9KinmuId(id: number, kinmu_id: number): UpdateConstraint9KinmuId {
  return {
    id,
    kinmu_id,
