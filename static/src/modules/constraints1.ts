...
const UPDATE_CONSTRAINT1_MIN_NUMBER_OF_ASSIGNMENTS = 'UPDATE_CONSTRAINT1_MIN_NUMBER_OF_ASSIGNMENTS'
...
export function createConstraint1(is_enabled: boolean, start_date_name: string, stop_date_name: string, kinmu_id: number, group_id: number, min_number_of_assignments: number): CreateConstraint1 {
  return {
    group_id,
    is_enabled,
    kinmu_id,
...
export function updateConstraint1IsEnabled(id: number, is_enabled: boolean): UpdateConstraint1IsEnabled {
  return {
    id,
    is_enabled,
...
export function updateConstraint1StartDateName(id: number, start_date_name: string): UpdateConstraint1StartDateName {
  return {
    id,
    start_date_name,
...
export function updateConstraint1StopDateName(id: number, stop_date_name: string): UpdateConstraint1StopDateName {
  return {
    id,
    stop_date_name,
...
export function updateConstraint1KinmuId(id: number, kinmu_id: number): UpdateConstraint1KinmuId {
  return {
    id,
    kinmu_id,
...
export function updateConstraint1GroupId(id: number, group_id: number): UpdateConstraint1GroupId {
  return {
    group_id,
    id,
...
export function updateConstraint1MinNumberOfAssignments(id: number, min_number_of_assignments: number): UpdateConstraint1MinNumberOfAssignments {
  return {
    id,
    min_number_of_assignments,
