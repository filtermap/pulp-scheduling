...
const UPDATE_CONSTRAINT6_MAX_NUMBER_OF_DAYS = 'UPDATE_CONSTRAINT6_MAX_NUMBER_OF_DAYS'
...
export function createConstraint6(is_enabled: boolean, kinmu_id: number, max_number_of_days: number): CreateConstraint6 {
  return {
    is_enabled,
    kinmu_id,
    max_number_of_days,
...
export function updateConstraint6IsEnabled(id: number, is_enabled: boolean): UpdateConstraint6IsEnabled {
  return {
    id,
    is_enabled,
...
export function updateConstraint6KinmuId(id: number, kinmu_id: number): UpdateConstraint6KinmuId {
  return {
    id,
    kinmu_id,
...
export function updateConstraint6MaxNumberOfDays(id: number, max_number_of_days: number): UpdateConstraint6MaxNumberOfDays {
  return {
    id,
    max_number_of_days,
