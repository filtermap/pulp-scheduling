...
export function createConstraint0Kinmu(constraint0_id: number, sequence_number: number, kinmu_id: number): CreateConstraint0Kinmu {
  return {
    constraint0_id,
    kinmu_id,
    sequence_number,
...
export function updateConstraint0KinmuKinmuId(id: number, kinmu_id: number): UpdateConstraint0KinmuKinmuId {
  return {
    id,
    kinmu_id,
