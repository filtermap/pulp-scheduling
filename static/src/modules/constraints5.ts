...
const UPDATE_CONSTRAINT5_MIN_NUMBER_OF_DAYS = 'UPDATE_CONSTRAINT5_MIN_NUMBER_OF_DAYS'
...
export function createConstraint5(is_enabled: boolean, kinmu_id: number, min_number_of_days: number): CreateConstraint5 {
  return {
    is_enabled,
    kinmu_id,
    min_number_of_days,
...
export function updateConstraint5IsEnabled(id: number, is_enabled: boolean): UpdateConstraint5IsEnabled {
  return {
    id,
    is_enabled,
...
export function updateConstraint5KinmuId(id: number, kinmu_id: number): UpdateConstraint5KinmuId {
  return {
    id,
    kinmu_id,
...
export function updateConstraint5MinNumberOfDays(id: number, min_number_of_days: number): UpdateConstraint5MinNumberOfDays {
  return {
    id,
    min_number_of_days,
