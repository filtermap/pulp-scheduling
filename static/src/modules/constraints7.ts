...
const UPDATE_CONSTRAINT7_MIN_NUMBER_OF_DAYS = 'UPDATE_CONSTRAINT7_MIN_NUMBER_OF_DAYS'
...
export function createConstraint7(is_enabled: boolean, kinmu_id: number, min_number_of_days: number): CreateConstraint7 {
  return {
    is_enabled,
    kinmu_id,
    min_number_of_days,
...
export function updateConstraint7IsEnabled(id: number, is_enabled: boolean): UpdateConstraint7IsEnabled {
  return {
    id,
    is_enabled,
...
export function updateConstraint7KinmuId(id: number, kinmu_id: number): UpdateConstraint7KinmuId {
  return {
    id,
    kinmu_id,
...
export function updateConstraint7MinNumberOfDays(id: number, min_number_of_days: number): UpdateConstraint7MinNumberOfDays {
  return {
    id,
    min_number_of_days,
