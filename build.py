...
subprocess.run(f"pyinstaller main.spec --clean --distpath {distribution_directory}", shell=True)

shutil.copytree("data", os.path.join(distribution_directory, "data"), copy_function=shutil.copy)
